...
After downloading the plugin, extract the contents. In Calibre upload the appropriate plugin ZIP package (*DeDRM_plugin* or *Obok_plugin*) or follow eReader specific directions.

- The latest beta is v10.0.9, a release candidate for v10.1.0. It [can be downloaded here](https://github.com/noDRM/DeDRM_tools/releases/tag/v10.0.9) at the bottom of the page. 
